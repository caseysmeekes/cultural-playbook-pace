 ...
 return <>
  <div className="quick-actions">
   ...
   {open&&<div className="qa-menu">
    ...
    <a href="/country-playbook"><strong>📚 Country Playbook</strong><small>Explore the country business & cultural encyclopaedia</small></a>
  ...
  {pathname==='/'&&<div className="qa-hint">New: <b>Country Playbook</b> is your business & cultural country encyclopaedia.</div>}
 </>
}
